...
from .adnl import Node, AdnlTransport, PeerAlreadyConnected
...
class DhtClient:
    ...
    def __init__(self,
        ...
        self.nodes_set: typing.Set[DhtNode] = set(nodes)
    ...
    @classmethod
    def from_mainnet_config(cls, adnl_transport: AdnlTransport) -> "DhtClient":
